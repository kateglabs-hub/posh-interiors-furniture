...
const products = [
  ...
  { name: "Nairobi Bouclé Sofa", category: "Sofas", group: "Sofas", image: "https://images.unsplash.com/photo-1540574163026-643ea20ade25?auto=format&fit=crop&w=900&q=85" },
  { name: "Saba Linen Sofa", category: "Sofas", group: "Sofas", image: "https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?auto=format&fit=crop&w=900&q=85" },
  ...
  { name: "Kisumu Dining Table", category: "Dining Tables", group: "Tables", image: "https://images.unsplash.com/photo-1617806118233-18e1de247200?auto=format&fit=crop&w=900&q=85" },
  { name: "The Kipepeo Lounge Chair", category: "Armchairs", group: "Armchairs", image: "/manus-storage/posh-furniture_66a3670d.jpg" },
  { name: "Pemba Accent Chair", category: "Armchairs", group: "Armchairs", image: "https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?auto=format&fit=crop&w=900&q=85" },
  { name: "The Asili Reading Chair", category: "Armchairs", group: "Armchairs", image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=900&q=85" },
  ...
  { name: "Mombasa Canopy Bed", category: "Beds", group: "Beds", image: "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&w=900&q=85" },
  { name: "The Wazi Platform Bed", category: "Beds", group: "Beds", image: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=900&q=85" },
  ...
  { name: "Diani Rattan Chair", category: "Outdoor Furniture", group: "Outdoor", image: "https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?auto=format&fit=crop&w=900&q=85" },
  { name: "Watamu Terrace Set", category: "Outdoor Furniture", group: "Outdoor", image: "https://images.unsplash.com/photo-1519947486511-46149fa0a254?auto=format&fit=crop&w=900&q=85" },
  ...
  { name: "Hand-finished Brass Curtain Rod", category: "Curtain Rods", group: "Curtains & Rods", image: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=900&q=85" },
  { name: "Sheer Voile Panel", category: "Curtains", group: "Curtains & Rods", image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=900&q=85" },
  ...
  { name: "Westlands Boardroom Table", category: "Office Furniture", group: "Office Furniture", image: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=900&q=85" },
  { name: "Nile Ergonomic Workstation", category: "Office Furniture", group: "Office Furniture", image: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=900&q=85" },
  { name: "Clearline Glass Lectern", category: "Glass Lecterns", group: "Glass Lecterns", image: "https://images.unsplash.com/photo-1540574163026-643ea20ade25?auto=format&fit=crop&w=900&q=85" },
  { name: "Sauti Acrylic Podium", category: "Glass Lecterns", group: "Glass Lecterns", image: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=900&q=85" },
  { name: "Kijani Glass Presentation Stand", category: "Glass Lecterns", group: "Glass Lecterns", image: "https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=900&q=85" },
  ...
  { name: "Sahara Textured Carpet", category: "Carpets & Rugs", group: "Carpets & Rugs", image: "https://images.unsplash.com/photo-1581783898377-1c85bf937427?auto=format&fit=crop&w=900&q=85" },
  { name: "Nakuru Flatweave Runner", category: "Carpets & Rugs", group: "Carpets & Rugs", image: "https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&w=900&q=85" },
  ...
  { name: "Kora Pendant Light", category: "Fittings", group: "Fittings", image: "https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?auto=format&fit=crop&w=900&q=85" },
  { name: "Olea Cabinet Handles", category: "Fittings", group: "Fittings", image: "https://images.unsplash.com/photo-1558997519-83ea9252edf8?auto=format&fit=crop&w=900&q=85" },
  ...
  { name: "Linear Cove Ceiling", category: "Gypsum & Ceilings", group: "Gypsum & Ceilings", image: "https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?auto=format&fit=crop&w=900&q=85" },
  { name: "Contemporary Bulkhead Detail", category: "Gypsum & Ceilings", group: "Gypsum & Ceilings", image: "https://images.unsplash.com/photo-1600607688969-a5bfcd646154?auto=format&fit=crop&w=900&q=85" },
];
